...
python3 /home/fb1n15/simulation-resource-allocation-multi-agent-RL/scripts/simulation_optimal_pricing_plus.py $VAR1 $VAR2 $VAR3 $VAR4 $VAR5 $VAR6 $VAR7 $VAR8 $VAR9 $VAR10 $VAR11
