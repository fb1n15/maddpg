...
cd "/home/fb1n15/simulation-resource-allocation-multi-agent-RL/scripts/"
...
python3 /home/fb1n15/simulation-resource-allocation-multi-agent-RL/scripts/train_reverse_auction_v2.py $VAR3 $VAR1
python3 /home/fb1n15/simulation-resource-allocation-multi-agent-RL/scripts/simulation_reverse_auction_v2.py $VAR1 $VAR2 $VAR3 $VAR4 $VAR5 $VAR6 $VAR7 $VAR8 $VAR9 $VAR10
