...
import online_optimal_m as oom
...
social_welfare, number_of_allocated_tasks, allocation_scheme = \
    oom.online_optimal(df_tasks, df_nodes, n_time, n_tasks, n_nodes, mipgap=mipgap)
...
with open("../simulation_results/2021-03-12/onlineOptimalResults_new.csv", "ab") as f:
